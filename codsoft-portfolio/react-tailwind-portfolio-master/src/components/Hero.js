...
export default function Hero() {
    const config  = {
        ...
        social: {
            github: 'https://github.com/SATHYARANGARAJ53',
            linkedin: 'https://www.linkedin.com/in/sathya53 ',
        }
    }
    ...
    return <section className='flex flex-col md:flex-row px-5 py-32 bg-primary justify-center'>
       <div className='md:w-1/2 flex flex-col'>
            <h1 className=' text-white text-6xl font-hero-font'>Hi, <br/> Im  <span className='text-black'>Sathya R</span> 
